...
class PreferenceView(context: Context) : MaterialCardView(context) {
    ...
    companion object {
        ...
        private const val CHEVRON_TINT = 0xFF999999.toInt()
    ...
    init {
        ...
        chevron = ImageView(context).apply {
            ...
            setColorFilter(CHEVRON_TINT)
            scaleType = ImageView.ScaleType.FIT_CENTER
            setPadding(ViewUtils.dp(6), ViewUtils.dp(6), ViewUtils.dp(6), ViewUtils.dp(6))
        }
        row.addView(chevron, LinearLayout.LayoutParams(ViewUtils.dp(40), ViewUtils.dp(40)).apply {
    ...
    fun bind(title: String, subtitle: String?, icon: Int = 0, tintColor: Int? = null) {
